...
public class PhieuDichVuController implements ActionListener{
    ...
    private void saveData() {
        if(this.isTableEmpty()!=true && mPhieuDichVuView.isAllTextFilled()==true)
        {
            ...
            if(nguoi==null)
            {
                String nextNguoiId = mPhieuDichVuModel.getNextIdOfNguoi();
            ...
            String nextIdPhieuThu = mPhieuDichVuModel.getNextIdOfPhieuThu();
            ...
            String nextIdPhieuDichVu = mPhieuDichVuView.getTextMaPhieu().getText();
    ...
    private void createView() {
        ...
        mPhieuDichVuView.getTextMaPhieu().setText(mPhieuDichVuModel.getNextIdOfPhieuDichVu());
